...
function renderRows() {
  ...
  body.innerHTML = rows.map((person) => {
    ...
    return `<tr>
      ...
      <td><div class="contractor-actions">${approve}<button class="secondary-action" type="button" data-edit="${esc(person.key)}"><span>Edit</span></button></div></td>
    </tr>`;
  }).join("");
